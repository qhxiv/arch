...
static const char *fonts[] = {"san-serif:pixelsize=13"};
...
static const char *colors[][3] = {
  ...
  [SchemeSel] = {col_gray1, col_gray3, col_gray4},
};
...
static const Key keys[] = {
  ...
  {MODKEY | ShiftMask,
    XK_b,
    spawn,
    {.v = (const char *[]){TERMINAL, "-e", "bluetui", NULL}}},
  // {MODKEY,
  //  XK_a,
  //  spawn,
  //  {.v = (const char *[]){TERMINAL, "-e", "ani-cli", NULL}}},
  {MODKEY, XK_Return, spawn, {.v = (const char *[]){TERMINAL, NULL}}},

  {MODKEY, XK_m, spawn,
    SHCMD(TERMINAL " --class cmus -e cmus; kill -37 $(pidof dwmblocks)")},
  {MODKEY, XK_bracketright, spawn,
    SHCMD("cmus-remote --next; kill -37 $(pidof dwmblocks)")},
  {MODKEY, XK_bracketleft, spawn,
    SHCMD("cmus-remote --prev; kill -37 $(pidof dwmblocks)")},
  {MODKEY,
    XK_Left,
    spawn,
    {.v = (const char *[]){"cmus-remote", "--seek", "-5", NULL}}},
  {MODKEY | ShiftMask,
    XK_Left,
    spawn,
    {.v = (const char *[]){"cmus-remote", "--seek", "-30", NULL}}},
  {MODKEY,
    XK_Right,
    spawn,
    {.v = (const char *[]){"cmus-remote", "--seek", "+5", NULL}}},
  ...
  {MODKEY,
    XK_p,
    spawn,
    {.v = (const char *[]){"cmus-remote", "--pause", NULL}}},
  {MODKEY,
    XK_minus,
    spawn,
    {.v = (const char *[]){"cmus-remote", "--volume", "-10%", NULL}}},
  {MODKEY,
    XK_equal,
    spawn,
    {.v = (const char *[]){"cmus-remote", "--volume", "+10%", NULL}}},
